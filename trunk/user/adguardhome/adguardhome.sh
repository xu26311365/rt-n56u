...
curl -k -s -o /tmp/AdGuardHome/AdGuardHome --connect-timeout 10 --retry 3 https://ghproxy.com/https://github.com/xu26311365/rt-n56u/blob/master/trunk/user/adguardhome/AdGuardHome?raw=true
