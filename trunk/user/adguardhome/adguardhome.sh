...
curl -k -s -o /tmp/AdGuardHome/AdGuardHome --connect-timeout 10 --retry 3 https://cdn.jsdelivr.net/gh/xu26311365/rt-n56u@master/trunk/user/adguardhome/AdGuardHome
